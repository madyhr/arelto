...
void UIImage::SetSrcRect(SDL_Rect src_rect) {
  src_rect_ = src_rect;
}
SDL_Texture* UIImage::GetTexture() const {
  return texture_;
}
SDL_Rect UIImage::GetSrcRect() const {
  return src_rect_;
}
...
TTF_Font* UILabel::GetFont() const {
  return font_;
}
...
bool UILabel::GetUseDigitFont() const {
  return use_digit_font_;
}
...
int UILabel::GetCharWidth() const {
  return char_width_;
}
int UILabel::GetCharHeight() const {
  return char_height_;
}
...
int UILabel::GetDigitSpriteWidth() const {
  return digit_sprite_width_;
}
int UILabel::GetDigitSpriteHeight() const {
...
void UIButton::SetTexture(SDL_Texture* texture) {
  texture_ = texture;
}
SDL_Texture* UIButton::GetTexture() const {
  return texture_;
}
...
SDL_Rect UIButton::GetNormalSrcRect() const {
  return normal_src_rect_;
}

void UIButton::SetHoverSrcRect(SDL_Rect src_rect) {
  hover_src_rect_ = src_rect;
}
SDL_Rect UIButton::GetHoverSrcRect() const {
  return hover_src_rect_;
}
...
void UIButton::SetLabelFont(TTF_Font* font) {
  label_font_ = font;
}
TTF_Font* UIButton::GetLabelFont() const {
  return label_font_;
}
...
const std::function<void()>& UIButton::GetOnClick() const {
  return on_click_;
}
...
void UICheckbox::SetBoxTexture(SDL_Texture* texture) {
  box_texture_ = texture;
}
SDL_Texture* UICheckbox::GetBoxTexture() const {
  return box_texture_;
}
void UICheckbox::SetBoxSrcRect(SDL_Rect src_rect) {
  box_src_rect_ = src_rect;
}
SDL_Rect UICheckbox::GetBoxSrcRect() const {
  return box_src_rect_;
}
void UICheckbox::SetBoxHoverSrcRect(SDL_Rect src_rect) {
  box_hover_src_rect_ = src_rect;
}
SDL_Rect UICheckbox::GetBoxHoverSrcRect() const {
  return box_hover_src_rect_;
}

SDL_Rect UICheckbox::GetCurrentBoxSrcRect() const {
  return hovered_ ? box_hover_src_rect_ : box_src_rect_;
}

void UICheckbox::SetMarkTexture(SDL_Texture* texture) {
  mark_texture_ = texture;
}
SDL_Texture* UICheckbox::GetMarkTexture() const {
  return mark_texture_;
}
void UICheckbox::SetMarkSrcRect(SDL_Rect src_rect) {
  mark_src_rect_ = src_rect;
}
SDL_Rect UICheckbox::GetMarkSrcRect() const {
  return mark_src_rect_;
}

WidgetType UICheckbox::GetWidgetType() const {
...
SDL_Texture* UIProgressBar::GetFillTexture() const {
  return fill_texture_;
}
void UIProgressBar::SetFillSrcRect(SDL_Rect src_rect) {
  fill_src_rect_ = src_rect;
}
SDL_Rect UIProgressBar::GetFillSrcRect() const {
...
int UIProgressBar::GetMaxFillWidth() const {
  return max_fill_width_;
}
int UIProgressBar::GetMaxFillHeight() const {
